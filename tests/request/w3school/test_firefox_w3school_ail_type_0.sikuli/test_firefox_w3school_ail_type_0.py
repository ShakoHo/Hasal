...
class Case(basecase.SikuliInputLatencyCase):
    ...
    def run(self):
        ...
        type_area = self.find_match_region(app.W3SCHOOL_EDITOR_MENU_ICONS, similarity=0.85)
        modified_area = self.tuning_region(type_area, y_offset=240, w_offset=120, h_offset=120)
